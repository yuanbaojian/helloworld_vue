			...
			<div class="vertical-box">
				...
				<div class="wrapper bg-silver-lighter clearfix">
					...
					<div class="pull-right">
						<div class="btn-group">
							<router-link to="/email/inbox" class="btn btn-white btn-sm disabled"><i class="fa fa-arrow-up f-s-14 t-plus-1"></i></router-link>
							<router-link to="/email/inbox" class="btn btn-white btn-sm"><i class="fa fa-arrow-down f-s-14 t-plus-1"></i></router-link>
						</div>
						<div class="btn-group m-l-5">
							<router-link to="/email/inbox" class="btn btn-white btn-sm"><i class="fa fa-times f-s-14 t-plus-1"></i></router-link>
						</div>
					</div>
				</div>
				<!-- end wrapper -->
				...
				<div class="wrapper bg-silver-lighter text-right clearfix">
					<div class="btn-group">
						<router-link to="/email/inbox" class="btn btn-white btn-sm disabled"><i class="fa fa-arrow-up"></i></router-link>
						<router-link to="/email/inbox" class="btn btn-white btn-sm"><i class="fa fa-arrow-down"></i></router-link>
					</div>
					<div class="btn-group m-l-5">
						<router-link to="/email/inbox" class="btn btn-white btn-sm"><i class="fa fa-times"></i></router-link>
					</div>
				</div>
				<!-- end wrapper -->
			</div>
