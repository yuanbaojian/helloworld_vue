...
&lt;/panel&gt;</code></pre>
				...
				<panel noButton="true">
					<template slot="header">
						<b-dropdown text="Action" variant="success" toggle-class="btn-xs" class="pull-right">
...
&lt;/panel&gt;</code></pre>
		...
		<div class="row">
			...
			<div class="col-lg-6">
				...
				<panel title="Panel Warning" variant="warning">
					...
					<div class="hljs-wrapper" slot="outsideBody" v-highlight>
						<pre><code class="html">&lt;div class="panel panel-warning"&gt;...&lt;/panel&gt;</code></pre>
					</div>
				</panel>
				<!-- end panel -->
				<!-- begin panel -->
				<panel title="Panel Danger" variant="danger">
					...
					<div class="hljs-wrapper" slot="outsideBody" v-highlight>
						<pre><code class="html">&lt;div class="panel panel-danger"&gt;...&lt;/panel&gt;</code></pre>
					</div>
				</panel>
				<!-- end panel -->
			</div>
			...
			<div class="col-lg-6">
				...
				<panel title="Panel Primary" variant="primary">
					...
					<div class="hljs-wrapper" slot="outsideBody" v-highlight>
						<pre><code class="html">&lt;div class="panel panel-primary"&gt;...&lt;/panel&gt;</code></pre>
					</div>
				</panel>
				<!-- end panel -->
				<!-- begin panel -->
				<panel title="Panel Info" variant="info">
					...
					<div class="hljs-wrapper" slot="outsideBody" v-highlight>
						<pre><code class="html">&lt;div class="panel panel-info"&gt;...&lt;/panel&gt;</code></pre>
					</div>
				</panel>
				<!-- end panel -->
			</div>
		...
		<div class="row">
			...
			<div class="col-lg-6">
				<!-- begin panel -->
				<panel title="Full Color Panel" bodyClass="bg-black">
					<p>Panel Content Here</p>
