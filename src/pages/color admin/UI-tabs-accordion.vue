		...
		<div class="row">
			...
			<div class="col-lg-6">
				...
				<div id="accordion" class="card-accordion">
					<!-- begin b-card -->
					<b-card no-body>
						<b-card-header header-tag="header" class="card-header bg-black text-white pointer-cursor" v-b-toggle.accordion1>
					...
					<!-- begin b-card -->
					<b-card no-body>
						<b-card-header header-tag="header" class="card-header bg-black text-white pointer-cursor" v-b-toggle.accordion2>
					...
					<!-- begin b-card -->
					<b-card no-body>
						<b-card-header header-tag="header" class="card-header bg-black text-white pointer-cursor" v-b-toggle.accordion3>
					...
					<!-- begin b-card -->
					<b-card no-body>
						<b-card-header header-tag="header" class="card-header bg-black text-white pointer-cursor" v-b-toggle.accordion4>
					...
					<!-- begin b-card -->
					<b-card no-body>
						<b-card-header header-tag="header" class="card-header bg-black text-white pointer-cursor" v-b-toggle.accordion5>
					...
					<!-- begin b-card -->
					<b-card no-body>
						<b-card-header header-tag="header" class="card-header bg-black text-white pointer-cursor" v-b-toggle.accordion6>
					...
					<!-- begin b-card -->
					<b-card no-body>
						<b-card-header header-tag="header" class="card-header bg-black text-white pointer-cursor" v-b-toggle.accordion7>
